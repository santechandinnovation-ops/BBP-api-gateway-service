...
app.add_middleware(
    ...
    allow_origins=[
        "http://localhost:8004",
        "http://localhost:3000",
        "https://bbp-frontend-service-production.up.railway.app"
    ],
...
async def root():
    return {
        ...
        "endpoints": {
            ...
            "users": "/api/users (profile, {user_id})",
            "trips": "/api/trips (list, create, get, coordinates, complete)",
            "paths": "/api/paths (manual, search, {path_id})"
        }
    }
